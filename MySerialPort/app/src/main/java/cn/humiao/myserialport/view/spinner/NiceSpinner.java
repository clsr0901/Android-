...
//            defaultPadding);
    ...
    public void setBackgroundLucency(Context context){
        popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.spinner_drawable_lucency));
    }
}
