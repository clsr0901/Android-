...
public class SerialPortUtil {
    ...
    public void openSerialPort(Context context) {
        try {
            ...
            String serial = SharedPreferencesUtil.getStringVaule(context, "port", ports[0]);
//            serialPort = new SerialPort(new File("/dev/ttyS3"), 9600, 0);
            serialPort = new SerialPort(new File(serial), 9600, 0);
            Log.e("port", "serial " + serial);
