...
public class Toasty {
    ...
    @ColorInt
    private static int ERROR_COLOR = Color.parseColor("#FFFD4949");
    @ColorInt
    private static int INFO_COLOR = Color.parseColor("#FF50BEFE");
    @ColorInt
    private static int SUCCESS_COLOR = Color.parseColor("#FF13CD66");
    @ColorInt
    private static int WARNING_COLOR = Color.parseColor("#FFF6B92A");
    @ColorInt
